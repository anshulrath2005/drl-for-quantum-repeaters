...
if __name__ == "__main__":
    ...
    print("========================================================")
    evaluate("models/marl_comm_agent/phase1/quantum_repeater_marl_agent_phase1", 1.0, "data/comm_test1_ages.json")
    ...
    print("========================================================")
    evaluate("models/marl_comm_agent/phase1/quantum_repeater_marl_agent_phase1", 0.5, "data/comm_test2_ages.json")
    ...
    print("========================================================")
    evaluate("models/marl_comm_agent/phase2/quantum_repeater_marl_agent", 0.5, "data/comm_test3_ages.json")
