...
if __name__ == "__main__":
    ...
    # Train Phase 1
    model.learn(total_timesteps=PHASE_1_STEPS, tb_log_name="PPO_NoComm_Phase1_Perfect_Hardware")
    model.save("models/marl_nocomm_agent/phase1/nocomm_agent_phase1")
    env_phase1.save("models/marl_nocomm_agent/phase1/nocomm_vec_normalize_phase1.pkl")
    ...
    # Train Phase 2
    model.learn(total_timesteps=PHASE_2_STEPS, tb_log_name="PPO_NoComm_Phase2_Noisy_Hardware", reset_num_timesteps=False)

    # Save the final Master agent
    model.save("models/marl_nocomm_agent/phase2/nocomm_agent")
    env_phase2.save("models/marl_nocomm_agent/phase2/nocomm_vec_normalize_phase2.pkl")
